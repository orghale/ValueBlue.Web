...
namespace ValueBlue.Web.Domain
{
    public class ConstMessage//ConstMessage.NOT_FOUND
    {
        ...
        public const string UNKNOWN_MONGO_ERROR = "Unknown error occurred while processing request";
        ...
        public const string OPERATION_SUCCESS = "Movie with title [{0}] has been successfully deleted";
    }
}
